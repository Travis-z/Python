...
of words/patterns in a set of words. A basic Trie however has O(number of characters stored) space complexity.
It provides O(min(search_string, length of longest word)) lookup.
"""
